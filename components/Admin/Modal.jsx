    ...
    return(
        <div id="drawer-navigation" className="fixed z-40 h-screen p-5 overflow-y-auto w-80 bg-black" tabIndex="-1" aria-labelledby="drawer-navigation-label">
            ...
            <div className="flex items-center p-1 text-base font-normal text-white">
                ...
                {/* nombre del usuario */}
                <span className="ml-3">{`nombre del admin`}</span>
            </div>
            <div className="py-4 overflow-y-auto">
                <ul className="space-y-2">
                    <li>
                        <Link href="/" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-300 hover:text-gray-800">
                    ...
                    <li>
                        <Link href="/reportes" className="flex items-center p-2 text-base font-normal text-white rounded-lg hover:bg-gray-300 hover:text-gray-800">
