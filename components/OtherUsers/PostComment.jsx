        ...
        <div className="">
            <form onSubmit={handleSubmit(actionHandler)}>
                ...
                <div className="flex items-center px-3 py-2 rounded-lg">
                    <textarea id="chat" rows="1" className="block mx-4 p-2.5 w-full text-sm text-white bg-gray-500 rounded-lg border focus:ring-yellow-10 border-gray-500" placeholder="Your message..."
