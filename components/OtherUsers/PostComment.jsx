        ...
        <div className="">
            ...
            <form>
                ...
                <div>
                    ...
                    <textarea id="message" rows="4" className={`block p-2.5 w-full text-sm text-gray-900 bg-amber-50 hover:bg-yellow-200 rounded-lg border border-gray-300 focus:ring-yellow-500 focus:bg-yellow-300 focus:border-amber-500 ${errors.comentario && 'border-red-500'} `} placeholder="Escribe tus comentarios aquí..." {...register("comentario", { required: true, pattern: /^[a-zA-Z\u00C0-\u017f\s]+?[0-9]{0,8}$/ })} ></textarea>
