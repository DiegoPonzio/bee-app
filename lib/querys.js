const MyQuerys = {
    ...
    fetchByCecyt: 'SELECT * FROM beepruebas.vw_ver WHERE ins_abreviatura = ?',
    fetchByAera: 'SELECT * FROM beepruebas.vw_ver WHERE area_nombre = ? AND ins_abreviatura= ?',
    fetchByEsp: 'SELECT * FROM beepruebas.vw_ver WHERE esp_nombre = ? AND ins_abreviatura= ?',
    fetchByEspId: 'SELECT * FROM beepruebas.vw_ver WHERE esp_nombre = (SELECT esp_nombre FROM especialidad WHERE esp_id = ?) AND ins_abreviatura= ?',
